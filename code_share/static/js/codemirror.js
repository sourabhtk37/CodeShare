!function(e, t) {
    ...
    function M(e, t, n) {
        ...
        ul && cl < 8 && (o.gutters.style.zIndex = -1,
    ...
    function W(e) {
        if (null == e.parent)
            return null;
        for (var t = e.parent, n = f(t.lines, e), r = t.parent; r; t = r,
        r = r.parent)
    ...
    function J(e, t) {
        ...
        if (a)
            for (var p = 0; p < a.length; ++p) {
                var v = a[p];
                null != v.to && (v.to += c),
                null == v.from ? _(s, v.marker) || (v.from = c,
                u && (s || (s = [])).push(v)) : (v.from += c,
                u && (s || (s = [])).push(v))
            }
        s && (s = ee(s)),
        a && a != s && (a = ee(a));
        ...
        if (!u) {
            ...
            if (b > 0 && s)
                for (var w = 0; w < s.length; ++w)
                    null == s[w].to && (y || (y = [])).push(new Y(s[w].marker,null,null));
            for (var x = 0; x < b; ++x)
                m.push(y);
            m.push(a)
        }
    ...
    function se(e, t) {
        var n, r = Ul && e.markedSpans;
        if (r)
            for (var i = void 0, o = 0; o < r.length; ++o)
                (i = r[o]).marker.collapsed && null == (t ? i.from : i.to) && (!n || le(n, i.marker) < 0) && (n = i.marker);
        return n
    }
    function ae(e) {
        return se(e, !0)
        ...
        if (l)
            for (var s = 0; s < l.length; ++s) {
                ...
                if (a.marker.collapsed) {
                    ...
                    if (!(c >= 0 && h <= 0 || c <= 0 && h >= 0) && (c <= 0 && (a.marker.inclusiveRight && i.inclusiveLeft ? P(u.to, n) >= 0 : P(u.to, n) > 0) || c >= 0 && (a.marker.inclusiveRight && i.inclusiveLeft ? P(u.from, r) <= 0 : P(u.from, r) < 0)))
                        return !0
                }
            }
    }
    ...
    function Ce(e, t, n) {
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.from < t && o.to > t)
                return i;
            o.to == t && (o.from != o.to && "before" == n ? r = i : Vl = i),
            o.from == t && (o.from != o.to && "before" != n ? r = i : Vl = i)
        }
        return null != r ? r : Vl
    }
    function Se(e, t) {
        var n = e.order;
        return null == n && (n = e.order = Kl(e.text, t)),
        n
    }
    function Le(e, t, n) {
    ...
    function Me(e, t, n, r, i) {
        if (e) {
            ...
            if (o) {
                var l, s = i < 0 ? g(o) : o[0], a = i < 0 == (1 == s.level) ? "after" : "before";
                if (s.level > 0) {
                    var u = qt(t, n);
    ...
    function Te(e, t, n, r) {
        ...
        var s, a = function(e, n) {
            ...
            return e.options.lineWrapping ? (s = s || qt(e, t),
            vn(e, t, s, n)) : {
                begin: 0,
                end: t.text.length
            }
    ...
    function Ge(e) {
        if (null == Wl) {
            ...
            0 != e.firstChild.offsetHeight && (Wl = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(ul && cl < 8))
        }
    ...
    function Ue(e) {
        ...
        return t(e),
        !(!i || i.left == i.right) && (Dl = o.right - i.right < 3)
    }
    function Ve(e) {
        if (null != Zl)
            return Zl;
    ...
    function je(e) {
        if ("string" == typeof e && Jl.hasOwnProperty(e))
            e = Jl[e];
        ...
        for (var l = n.state, s = 0; s < e.state.overlays.length; ++s)
            !function(r) {
                var l = e.state.overlays[r]
                  ...
                  , a = 0;
                n.state = !0,
                ot(e, t.text, l.mode, n, function(e, t) {
                    for (var n = s; a < e; ) {
                        var r = i[s];
    ...
    function rt(e, t, n, r) {
        var i, o, l = e.doc, s = l.mode, a = T(l, (t = U(l, t)).line), u = Je(e, t.line, n), c = new ts(a.text,e.options.tabSize,u);
        for (r && (o = []); (r || c.pos < t.ch) && !c.eol(); )
            c.start = c.pos,
            i = nt(s, c, u.state),
            r && o.push(new is(c,i,_e(l.mode, u.state)));
    ...
    function ot(e, t, n, r, i, o, l) {
        ...
        var a, u = 0, c = null, h = new ts(t,e.options.tabSize,r), f = e.options.addModeClass && [null];
        for ("" == t && it(tt(n, r.state), o); !h.eol(); ) {
            if (h.pos > e.options.maxHighlightLength ? (s = !1,
            l && et(e, t, r, h.pos),
            h.pos = t.length,
            a = null) : a = it(nt(n, h, r.state, f), o),
            f) {
                var d = f[0].name;
                d && (a = "m-" + (a ? d + " " + a : d))
            }
    ...
    function lt(e, t, n) {
        for (var r, i, o = e.doc, l = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t; s > l; --s) {
            ...
            var a = T(o, s - 1)
              , u = a.stateAfter;
            if (u && (!n || s + (u instanceof ns ? u.lookAhead : 0) <= o.modeFrontier))
                return s;
    ...
    function ht(e, t) {
        var n = i("span", null, null, hl ? "padding-right: .1px" : null)
          , r = {
            ...
            cm: e,
            trailingSpace: !1,
            splitSpaces: (ul || hl) && e.getOption("lineWrapping")
        };
        t.measure = {};
        for (var o = 0; o <= (t.rest ? t.rest.length : 0); o++) {
            ...
            l.styleClasses && (l.styleClasses.bgClass && (r.bgClass = a(l.styleClasses.bgClass, r.bgClass || "")),
            l.styleClasses.textClass && (r.textClass = a(l.styleClasses.textClass, r.textClass || ""))),
        ...
        r.pre.className && (r.textClass = a(r.pre.className, r.textClass || "")),
        r
    }
    function ft(e) {
    ...
    function dt(e, t, n, i, o, l, s) {
        if (t) {
            var a, u = e.splitSpaces ? pt(t, e.trailingSpace) : t, c = e.cm.state.specialChars, h = !1;
            if (c.test(t)) {
                ...
                for (var f = 0; ; ) {
                    ...
                    if (g) {
                        ...
                        ul && cl < 9 ? a.appendChild(r("span", [v])) : a.appendChild(v),
                    ...
                    if ("\t" == d[0]) {
                        var y = e.cm.options.tabSize
                          , b = y - e.col % y;
                        (m = a.appendChild(r("span", p(b), "cm-tab"))).setAttribute("role", "presentation"),
                        m.setAttribute("cm-text", "\t"),
                        e.col += b
                    } else
                        "\r" == d[0] || "\n" == d[0] ? ((m = a.appendChild(r("span", "\r" == d[0] ? "␍" : "␤", "cm-invalidchar"))).setAttribute("cm-text", d[0]),
                        e.col += 1) : ((m = e.cm.options.specialCharPlaceholder(d[0])).setAttribute("cm-text", d[0]),
                        ul && cl < 9 ? a.appendChild(r("span", [m])) : a.appendChild(m),
                        e.col += 1);
        ...
        return function(n, r, i, o, l, s, a) {
            ...
            for (var u = n.pos, c = u + r.length; ; ) {
                for (var h = void 0, f = 0; f < t.length && !((h = t[f]).to > u && h.from <= u); f++)
                    ;
                if (h.to >= c)
                    return e(n, r, i, o, l, s, a);
                e(n, r.slice(0, h.to - u), i, o, null, s, a),
                o = null,
                r = r.slice(h.to - u),
                u = h.to
            }
            ...
            for (var l, s, a, u, c, h, f, d = i.length, p = 0, g = 1, v = "", m = 0; ; ) {
                if (m == p) {
                    ...
                    for (var y = [], b = void 0, w = 0; w < r.length; ++w) {
                        ...
                        C.title && !h && (h = C.title),
                        C.collapsed && (!f || le(f.marker, C) < 0) && (f = x)) : x.from > p && m > x.from && (m = x.from)
                    }
                    if (b)
                    ...
                    if (!f || f.from == p)
                        for (var L = 0; L < y.length; ++L)
                            vt(t, 0, y[L]);
                    if (f && (f.from || 0) == p) {
                        if (vt(t, (null == f.to ? d + 1 : f.to) - p, f.marker, null == f.from),
                        null == f.to)
                            return;
                        f.to == p && (f = !1)
                    }
    ...
    function yt(e, t, n) {
        this.line = t,
        this.rest = de(t),
        this.size = this.rest ? W(g(this.rest)) - n + 1 : 1,
    ...
    function wt(e) {
        us ? us.ops.push(e) : e.ownsGroup = us = {
            ops: [e],
            delayedCallbacks: []
        }
    }
    ...
    function St(e, t) {
        ...
        if (n.length) {
            ...
            us ? r = us.delayedCallbacks : cs ? r = cs : (r = cs = [],
            setTimeout(Lt, 0));
    ...
    function Ot(e, t) {
        ...
        At(e, t)) : n && (t.text.className = n)
    }
    function At(e, t) {
        Tt(e, t),
        t.line.wrapClass ? Mt(t).className = t.line.wrapClass : t.node != t.text && (t.node.className = "");
    ...
    function Wt(e, t, n, i) {
        ...
        if (e.options.lineNumbers || l) {
            ...
            !e.options.lineNumbers || l && l["CodeMirror-linenumbers"] || (t.lineNumber = a.appendChild(r("div", F(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + i.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
            l)
    ...
    function qt(e, t) {
        var n = W(t)
          , r = $t(e, n);
        r && !r.text ? r = null : r && r.changes && (kt(e, r, n, wn(e)),
    ...
    function Zt(e, t, n, r, i) {
        ...
        t.hasHeights = !0),
        (o = en(e, t, n, r)).bogus || (t.cache[l] = o)),
        {
            left: o.left,
            right: o.right,
            top: i ? o.rtop : o.top,
    ...
    function en(e, t, n, r) {
        var i, o = Qt(t.map, n, r), l = o.node, s = o.start, a = o.end, u = o.collapse;
        if (3 == l.nodeType) {
            for (var c = 0; c < 4; c++) {
                for (; s && S(t.line.text.charAt(o.coverStart + s)); )
                    --s;
                for (; o.coverStart + a < o.coverEnd && S(t.line.text.charAt(o.coverStart + a)); )
                    ++a;
                if ((i = ul && cl < 9 && 0 == s && a == o.coverEnd - o.coverStart ? l.parentNode.getBoundingClientRect() : Jt(kl(l, s, a).getClientRects(), r)).left || i.right || 0 == s)
                    break;
                a = s,
                s -= 1,
                u = "right"
    ...
    function an(e, t, n, r, i) {
        ...
        r || (r = "local");
        var s = ye(t);
        if ("local" == r ? s += zt(e.display) : s -= e.display.viewOffset,
        "page" == r || "window" == r) {
    ...
    function hn(e, t, n, r, i, o) {
        ...
        var h = Ce(a, u, c)
          , f = Vl
          , d = s(u, h, "before" == c);
        return null != f && (d.other = s(u, f, "before" != c)),
        d
    }
    function fn(e, t) {
        var n = 0;
    ...
    function pn(e, t, n) {
        ...
        if ((n += e.display.viewOffset) < 0)
            return dn(r.first, 0, null, !0, -1);
        var i = D(r, n)
          , o = r.first + r.size - 1;
        if (i > o)
            return dn(r.first + r.size - 1, T(r, o).text.length, null, !0, 1);
        t < 0 && (t = 0);
        for (var l = T(r, i); ; ) {
            var s = mn(e, l, i, t, n)
              , a = ue(l)
    ...
    function mn(e, t, n, r, i) {
        i -= ye(t);
        var o, l = 0, s = t.text.length, a = qt(e, t);
        if (Se(t, e.doc.direction)) {
            if (e.options.lineWrapping) {
                var u;
                l = (u = gn(e, t, a, i)).begin,
                s = u.end
            }
            o = new E(n,Math.floor(l + (s - l) / 2));
            var c, h, f = hn(e, o, "line", t, a).left, d = f < r ? 1 : -1, p = f - r, g = Math.ceil((s - l) / 4);
            e: do {
                c = p,
                h = o;
                for (var v = 0; v < g; ++v) {
                ...
                if (p = hn(e, o, "line", t, a).left - r,
                g > 1) {
                    var y = Math.abs(p - c) / g;
                    g = Math.min(g, Math.ceil(Math.abs(p) / y)),
                    d = p < 0 ? 1 : -1
                }
            } while (0 != p && (g > 1 || d < 0 != p < 0 && Math.abs(p) <= Math.abs(c)));if (Math.abs(p) > Math.abs(c)) {
                if (p < 0 == c < 0)
    ...
    function Ln(e, t, n, r) {
        var i = e.display;
        if (!n && "true" == ze(t).getAttribute("cm-not-content"))
            return null;
        ...
        for (var n = e.doc, r = {}, i = r.cursors = document.createDocumentFragment(), o = r.selection = document.createDocumentFragment(), l = 0; l < n.sel.ranges.length; l++)
            if (!1 !== t || l != n.sel.primIndex) {
                ...
                if (!(s.from().line >= e.display.viewTo || s.to().line < e.display.viewFrom)) {
                    var a = s.empty();
                    (a || e.options.showCursorWhenSelecting) && Nn(e, s.head, i),
                    a || On(e, s, o)
                }
            }
        return r
    ...
    function On(e, t, n) {
        function i(e, t, n, i) {
            ...
            t = Math.round(t),
            i = Math.round(i),
            a.appendChild(r("div", null, "CodeMirror-selected", "position: absolute; left: " + e + "px;\n                             top: " + t + "px; width: " + (null == n ? h - e : n) + "px;\n                             height: " + (i - t) + "px"))
        }
        function o(t, n, r) {
            function o(n, r) {
                return cn(e, E(t, n), "div", u, r)
            }
            var l, a, u = T(s, t), f = u.text.length;
            return xe(Se(u, s.direction), n || 0, null == r ? f : r, function(e, t, s) {
                ...
                null == n && 0 == e && (d = c),
                u.top - g.top > 3 && (i(d, g.top, null, g.bottom),
                d = c,
                g.bottom < u.top && i(d, g.bottom, null, u.top)),
                null == r && t == f && (p = h),
        ...
        if (f.line == d.line)
            ...
            i(c, y.top, y.left, y.bottom)) : i(m.right, m.top, y.left - m.right, m.bottom)),
    ...
    function Fn(e, t) {
        ...
        e.state.focused = !1,
        Nl(e.display.wrapper, "CodeMirror-focused")),
    ...
    function In(e, t, n) {
        ...
        if (n && n.ensure) {
            var s = n.ensure.from.line
              , a = n.ensure.to.line;
            s < o ? (o = s,
            l = D(t, ye(T(t, s)) + e.wrapper.clientHeight)) : Math.min(a, t.lastLine()) >= l && (o = D(t, ye(T(t, a)) - e.wrapper.clientHeight),
            l = a)
        }
        return {
            from: o,
    ...
    function Gn(e, t, n, r) {
        ...
        for (var o = 0; o < 5; o++) {
            var l = !1
              ...
              , c = e.doc.scrollTop
              , h = e.doc.scrollLeft;
            if (null != u.scrollTop && (qn(e, u.scrollTop),
            Math.abs(e.doc.scrollTop - c) > 1 && (l = !0)),
            null != u.scrollLeft && (Qn(e, u.scrollLeft),
    ...
    function Un(e, t) {
        var n = Vn(e, t);
        null != n.scrollTop && qn(e, n.scrollTop),
    ...
    function _n(e) {
        ...
        $n(e, fn(e, t.from), fn(e, t.to), t.margin))
    }
    function $n(e, t, n, r) {
        var i = Vn(e, {
    ...
    function qn(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 || (ol || Nr(e, {
            top: t
        }),
        Zn(e, t, !0),
        ol && Nr(e),
    ...
    function er(e, t) {
        ...
        for (var i = 0; i < 4 && n != e.display.barWidth || r != e.display.barHeight; i++)
            n != e.display.barWidth && e.options.lineWrapping && En(e),
            tr(e, Jn(e)),
    ...
    function nr(e) {
        ...
        e.display.scrollbars.addClass && Nl(e.display.wrapper, e.display.scrollbars.addClass)),
        e.display.scrollbars = new ps[e.options.scrollbarStyle](function(t) {
    ...
    function lr(e) {
        ...
        e.update = e.mustUpdate && new vs(t,e.mustUpdate && {
            top: e.scrollTop,
    ...
    function ar(e) {
        ...
        e.barMeasure = Jn(t),
        n.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = _t(t, n.maxLine, n.maxLine.text.length).left + 3,
    ...
    function cr(e) {
        ...
        if (i)
            for (var l = 0; l < i.length; ++l)
                i[l].lines.length || Ae(i[l], "hide");
        if (o)
            for (var s = 0; s < o.length; ++s)
                o[s].lines.length && Ae(o[s], "unhide");
    ...
    function gr(e, t, n, r) {
        ...
        t >= i.viewTo)
            Ul && pe(e.doc, t) < i.viewTo && mr(e);
        else if (n <= i.viewFrom)
            Ul && ge(e.doc, n + r) > i.viewFrom ? mr(e) : (i.viewFrom += r,
            i.viewTo += r);
            ...
            i.viewTo = l.lineN) : mr(e)
        } else {
            var s = yr(e, t, t, -1)
              , a = yr(e, n, n + r, 1);
            s && a ? (i.view = i.view.slice(0, s.index).concat(bt(e, s.lineN, a.lineN)).concat(i.view.slice(a.index)),
            i.viewTo += r) : mr(e)
        }
    ...
    function yr(e, t, n, r) {
        var i, o = kn(e, t), l = e.display.view;
        if (!Ul || n == e.doc.first + e.doc.size)
            return {
                index: o,
                lineN: n
            };
    ...
    function br(e, t, n) {
        ...
        r.viewFrom = t) : (r.viewFrom > t ? r.view = bt(e, t, r.viewFrom).concat(r.view) : r.viewFrom < t && (r.view = r.view.slice(kn(e, t))),
        r.viewFrom = t,
    ...
    function Mr(e, n) {
        ...
        br(e, l, s),
        r.viewOffset = ye(T(e.doc, r.viewFrom)),
        e.display.mover.style.top = r.viewOffset + "px";
        var u = wr(e);
        if (!a && 0 == u && !n.force && r.renderedView == r.view && (null == r.updateLineNumbers || r.updateLineNumbers >= r.viewTo))
            return !1;
        var c = Lr(e);
        ...
        a && (r.lastWrapHeight = n.wrapperHeight,
    ...
    function Tr(e, t) {
        for (var n = t.viewport, r = !0; (r && e.options.lineWrapping && t.oldDisplayWidth != Vt(e) || (n && null != n.top && (n = {
            top: Math.min(e.doc.height + Bt(e.display) - Kt(e), n.top)
        }),
        t.visible = In(e.display, e.doc, n),
        !(t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo))) && Mr(e, t); r = !1) {
            En(e);
            var i = Jn(e);
            Mn(e),
            er(e, i),
    ...
    function Or(e, n, r) {
        function i(t) {
            var n = t.nextSibling;
            return hl && xl && e.display.currentWheelTarget == t ? t.style.display = "none" : t.parentNode.removeChild(t),
            n
        }
        for (var o = e.display, l = e.options.lineNumbers, s = o.lineDiv, a = s.firstChild, u = o.view, c = o.viewFrom, h = 0; h < u.length; h++) {
            ...
            if (d.hidden)
                ...
                d.changes && (f(d.changes, "gutter") > -1 && (p = !1),
                kt(e, d, c, r)),
                p && (t(d.lineNumber),
                d.lineNumber.appendChild(document.createTextNode(F(e.options, c)))),
    ...
    function Pr(e, t) {
        ...
        if (r && s || i && a) {
            ...
            if (r && !ol && !pl && null != ys)
                return i && a && qn(e, Math.max(0, l.scrollTop + i * ys)),
                Qn(e, Math.max(0, l.scrollLeft + r * ys)),
                (!i || i && a) && Ee(t),
            ...
            ms < 20 && (null == o.wheelStartX ? (o.wheelStartX = l.scrollLeft,
    ...
    function Ir(e, t) {
        ...
        for (var r = 1; r < e.length; r++) {
            ...
            if (P(o.to(), i.from()) >= 0) {
                ...
                r <= t && --t,
                e.splice(--r, 2, new ws(a ? s : l,a ? l : s))
            }
        }
        return new bs(e,t)
    }
    ...
    function Yr(e, t, n, r) {
        ...
        if (t.full)
            ...
            if (1 == u.length)
                ...
                m.push(new os(f + c.text.slice(a.ch),d,r)),
    ...
    function ni(e, t, n, r) {
        ...
        if ((i.lastOp == r || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && e.cm && i.lastModTime > s - e.cm.options.historyEventDelay || "*" == t.origin.charAt(0))) && (o = ti(i, i.lastOp == r)))
            l = g(o.changes),
            0 == P(t.from, t.to) && 0 == P(t.from, l.to) ? l.to = zr(t) : o.changes.push(Jr(e, t));
        else {
            var a = g(i.done);
            for (a && a.ranges || oi(e.sel, i.done),
            o = {
                changes: [Jr(e, t)],
    ...
    function ci(e, t, n) {
        for (var r = [], i = 0; i < e.length; ++i) {
            var o = e[i];
            if (o.ranges)
                r.push(n ? bs.prototype.deepCopy.call(o) : o);
            else {
                var l = o.changes
                  , s = [];
                r.push({
                ...
                for (var a = 0; a < l.length; ++a) {
                    ...
                    t)
                        for (var h in u)
                            (c = h.match(/^spans_(\d+)$/)) && f(t, Number(c[1])) > -1 && (g(s)[h] = u[h],
                            delete u[h])
                }
            }
        }
    ...
    function fi(e, t, n, r, i) {
        ...
        yi(e, new bs([hi(e.sel.primary(), t, n, i)],0), r)
    }
    function di(e, t, n) {
    ...
    function vi(e, t, n) {
        var r = {
            ...
            update: function(t) {
                ...
                this.ranges = [];
                for (var r = 0; r < t.length; r++)
                    n.ranges[r] = new ws(U(e, t[r].anchor),U(e, t[r].head))
            },
            origin: n && n.origin
        };
        return Ae(e, "beforeSelectionChange", e, r),
        e.cm && Ae(e.cm, "beforeSelectionChange", e.cm, r),
        r.ranges != t.ranges ? Ir(r.ranges, r.ranges.length - 1) : t
    }
    function mi(e, t, n) {
            ...
            for (var l = 0; l < o.markedSpans.length; ++l) {
                ...
                if ((null == s.from || (a.inclusiveLeft ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (a.inclusiveRight ? s.to >= t.ch : s.to > t.ch))) {
                    ...
                    if (n) {
                        ...
                        u && u.line == t.line && (c = P(u, n)) && (r < 0 ? c < 0 : c > 0))
                            return Si(e, u, t, r, i)
                    }
                    var h = a.find(r < 0 ? -1 : 1);
                    return (r < 0 ? a.inclusiveLeft : a.inclusiveRight) && (h = ki(e, h, r, h.line == t.line ? o : null)),
                    h ? Si(e, h, t, r, i) : null
                }
            }
        return t
    ...
    function Oi(e, t) {
        if (1 != t.text.length || "" != t.text[0] || 0 != P(t.from, t.to)) {
            ...
            var r = [];
            _r(e, function(e, n) {
                n || -1 != f(r, e.history) || (Ii(e.history, t),
                r.push(e.history)),
                Di(e, t, null, J(e, t))
            })
        }
            ...
            if (a != l.length) {
                ...
                for (var c = He(e, "beforeChange") || e.cm && He(e.cm, "beforeChange"), h = r.changes.length - 1; h >= 0; --h) {
                    var d = function(n) {
                        ...
                        var s = [];
                        _r(e, function(e, t) {
                            t || -1 != f(s, e.history) || (Ii(e.history, i),
                            s.push(e.history)),
                            Di(e, i, null, ui(e, i))
                        })
                    }(h);
    ...
    function Wi(e, t) {
        if (0 != t && (e.first += t,
        e.sel = new bs(v(e.sel.ranges, function(e) {
    ...
    function Di(e, t, n, r) {
        if (e.cm && !e.cm.curOp)
            return fr(e.cm, Di)(e, t, n, r);
        if (t.to.line < e.first)
            Wi(e, t.text.length - 1 - (t.to.line - t.from.line));
    ...
    function Hi(e, t, n) {
        var r = e.doc
          ...
          , s = !1
          , a = o.line;
        e.options.lineWrapping || (a = W(he(T(r, o.line))),
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var s = 0; s < o.ranges.length; s++)
                    Ei(o.ranges[s].anchor, t, n, r),
                    Ei(o.ranges[s].head, t, n, r)
            } else {
                for (var a = 0; a < o.changes.length; ++a) {
                    var u = o.changes[a];
                    if (n < u.from.line)
                        u.from = E(u.from.line + r, u.from.ch),
    ...
    function Ri(e, t, n, r) {
        var i = t
          , o = t;
        return "number" == typeof t ? o = T(e, G(e, t)) : i = W(t),
    ...
    function Vi(e, t, n, r, o) {
        if (r && r.shared)
            return Ki(e, t, n, r, o);
        if (e.cm && !e.cm.curOp)
            return fr(e.cm, Vi)(e, t, n, r, o);
        var l = new Ss(e,o)
          , s = P(t, n);
        if (r && c(r, l, !1),
        s > 0 || 0 == s && !1 !== l.clearWhenEmpty)
            return l;
        if (l.replacedWith && (l.collapsed = !0,
        l.widgetNode = i("span", [l.replacedWith], "CodeMirror-widget"),
        r.handleMouseEvents || l.widgetNode.setAttribute("cm-ignore-events", "true"),
        r.insertLeft && (l.widgetNode.insertLeft = !0)),
        l.collapsed) {
            if (ce(e, t.line, t, n, l) || t.line != n.line && ce(e, n.line, t, n, l))
        ...
        if (e.iter(u, n.line + 1, function(e) {
            h && l.collapsed && !h.options.lineWrapping && he(e) == h.display.maxLine && (a = !0),
            l.collapsed && u != t.line && A(e, 0),
            q(e, new Y(l,u == t.line ? t.ch : null,u == n.line ? n.ch : null)),
            ++u
        }),
        l.collapsed && e.iter(t.line, n.line + 1, function(t) {
            ve(e, t) && A(t, 0)
        }),
        l.clearOnEnter && Xl(l, "beforeCursorEnter", function() {
            return l.clear()
        }),
        l.readOnly && (j(),
                        ...
                        if (a) {
                            ...
                            u)
                                for (var c = 0; c < u.length; ++c)
                                    Fi(t.doc, "", u[c].anchor, u[c].head, "drag");
    ...
    function $i(e, t) {
        if (ul && (!e.state.draggingText || +new Date - Ts < 100))
            Re(t);
        else if (!We(e, t) && !Rt(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()),
        t.dataTransfer.effectAllowed = "copyMove",
        t.dataTransfer.setDragImage && !gl)) {
    ...
    function uo(e, t) {
        ...
        hr(e, function() {
            for (var t = r.length - 1; t >= 0; t--)
                Fi(e.doc, "", r[t].from, r[t].to, "+delete");
            jn(e)
        })
    }
    function co(e, t) {
    ...
    function bo(e) {
        ...
        !We(t, e)) {
            ...
            var r = mo(t, e);
            pl && (Ps = r ? n : null,
            !r && 88 == n && !ql && (xl ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
            18 != n || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || wo(t)
        }
    }
    function wo(e) {
        function t(e) {
            18 != e.keyCode && e.altKey || (Nl(n, "CodeMirror-crosshair"),
            Oe(document, "keyup", t),
            Oe(document, "mouseover", t))
        }
        var n = e.display.lineDiv;
        s(n, "CodeMirror-crosshair"),
        Xl(document, "keyup", t),
        Xl(document, "mouseover", t)
    }
    function xo(e) {
    ...
    function So(e, t) {
        var n = +new Date;
        return zs && zs.compare(n, e, t) ? (Rs = zs = null,
        "triple") : Rs && Rs.compare(n, e, t) ? (zs = new Is(n,e,t),
        Rs = null,
        "double") : (Rs = new Is(n,e,t),
        zs = null,
        "single")
    }
    function Lo(e) {
        ...
        if (!(We(t, e) || n.activeTouch && n.input.supportsTouch()))
            ...
            Rt(n, e))
                ...
                r && ko(t, i, r, o, e) || (1 == i ? r ? To(t, r, o, e) : ze(e) == n.scroller && Ee(e) : 2 == i ? (r && fi(t.doc, r),
                setTimeout(function() {
                    return n.input.focus()
                }, 20)) : 3 == i && (Tl ? Ho(t, e) : Dn(t)))
            }
    }
    ...
    function Mo(e, t, n) {
        ...
        null == i.addNew && (i.addNew = xl ? n.metaKey : n.ctrlKey),
        null == i.moveOnDrag && (i.moveOnDrag = !(xl ? n.altKey : n.ctrlKey)),
        i
    }
    function To(e, t, n, r) {
        ul ? setTimeout(u(Wn, e), 0) : e.curOp.focus = l();
        var i, o = Mo(e, n, r), s = e.doc.sel;
    ...
    function No(e, t, n, r) {
        var i = e.display
          ...
          , l = fr(e, function(t) {
            ...
            hl || ul && 9 == cl ? setTimeout(function() {
                document.body.focus(),
                i.input.focus()
            }, 20) : i.input.focus())
        })
    ...
    function Oo(e, t, n) {
        ...
        if ("line" == n)
            return new ws(E(t.line, 0),U(e.doc, E(t.line + 1, 0)));
        var r = n(e, t);
    ...
    function Ao(e, t, n, r) {
        function i(t) {
            if (0 != P(m, t))
                if (m = t,
                "rectangle" == r.unit) {
                    for (var i = [], o = e.options.tabSize, l = h(T(u, n.line).text, n.ch, o), s = h(T(u, t.line).text, t.ch, o), a = Math.min(l, s), g = Math.max(l, s), v = Math.min(n.line, t.line), y = Math.min(e.lastLine(), Math.max(n.line, t.line)); v <= y; v++) {
                        var b = T(u, v).text
                          , w = d(b, a, o);
                        a == g ? i.push(new ws(E(v, w),E(v, w))) : b.length > w && i.push(new ws(E(v, w),E(v, d(b, g, o))))
                    }
                    i.length || i.push(new ws(n,n)),
                    yi(u, Ir(p.ranges.slice(0, f).concat(i), f), {
                        origin: "*mouse",
                        scroll: !1
                    }),
                    e.scrollIntoView(t)
                } else {
                    var x, C = c, S = Oo(e, t, r.unit), L = C.anchor;
                    P(S.anchor, L) > 0 ? (x = S.head,
                    L = B(C.from(), S.anchor)) : (x = S.anchor,
                    L = z(C.to(), S.head));
        ...
        function o(t) {
            ...
            if (s)
                if (0 != P(s, m)) {
                    ...
                    i(s);
                    var c = In(a, u);
                    (s.line >= c.to || s.line < c.from) && setTimeout(fr(e, function() {
                        b == n && o(t)
                    }), 150)
                } else {
                    var h = t.clientY < y.top ? -20 : t.clientY > y.bottom ? 20 : 0;
                    h && setTimeout(fr(e, function() {
                        b == n && (a.scroller.scrollTop += h,
                        o(t))
                    }), 50)
                }
        }
        function s(t) {
            ...
            Ee(t),
            a.input.focus(),
            Oe(document, "mousemove", w),
            Oe(document, "mouseup", x),
        ...
        if (r.addNew && !r.extend ? (f = u.sel.contains(n),
        c = f > -1 ? g[f] : new ws(n,n)) : (c = u.sel.primary(),
        f = u.sel.primIndex),
        "rectangle" == r.unit)
            r.addNew || (c = new ws(n,n)),
            n = Ln(e, t, !0, !0),
            f = -1;
        else {
            var v = Oo(e, n, r.unit);
        ...
        r.addNew ? -1 == f ? (f = g.length,
        yi(u, Ir(g.concat([c]), f), {
            scroll: !1,
            origin: "*mouse"
        })) : g.length > 1 && g[f].empty() && "char" == r.unit && !r.extend ? (yi(u, Ir(g.slice(0, f).concat(g.slice(f + 1)), 0), {
            scroll: !1,
            origin: "*mouse"
        }),
        p = u.sel) : pi(u, f, c, Pl) : (f = 0,
        yi(u, new bs([c],0), Pl),
        p = u.sel);
        var m = n
        ...
        Xl(document, "mousemove", w),
        Xl(document, "mouseup", x)
    }
    function Wo(e, t, n, r) {
        var i, o;
        try {
        ...
        for (var a = 0; a < e.options.gutters.length; ++a) {
            ...
            if (u && u.getBoundingClientRect().right >= i)
                return Ae(e, n, e, D(e.doc, o), e.options.gutters[a], t),
                Ie(t)
        }
    }
    function Do(e, t) {
    ...
    function Ro(e) {
        ...
        e.display.sizerWidth = null) : (Nl(e.display.wrapper, "CodeMirror-wrap"),
        we(e)),
        Sn(e),
        gr(e),
        on(e),
    ...
    function zo(e, t) {
        ...
        Hr(t);
        var r = t.value;
        "string" == typeof r && (r = new Ms(r,t.mode,null,t.lineSeparator,t.direction)),
        this.doc = r;
        ...
        for (var l in Us)
            Us.hasOwnProperty(l) && Us[l](n, t[l], Bs);
        zn(this),
        t.finishInit && t.finishInit(this);
        for (var s = 0; s < Vs.length; ++s)
            Vs[s](n);
        ir(this),
        hl && t.lineWrapping && "optimizelegibility" == getComputedStyle(o.lineDiv).textRendering && (o.lineDiv.style.textRendering = "auto")
    }
    function Bo(e) {
        function t() {
        ...
        ul && cl < 11 ? Xl(i.scroller, "dblclick", fr(e, function(t) {
            if (!We(e, t)) {
                var n = Ln(e, t);
        ...
        Tl || Xl(i.scroller, "contextmenu", function(t) {
            return Ho(e, t)
        });
        var o, l = {
            end: 0
        ...
        Xl(i.scroller, "touchend", function(n) {
            ...
            if (o && !Rt(i, n) && null != o.left && !o.moved && new Date - o.start < 300) {
                ...
                l = !o.prev || r(o, o.prev) ? new ws(s,s) : !o.prev.prev || r(o, o.prev.prev) ? e.findWordAt(s) : new ws(E(s.line, 0),U(e.doc, E(s.line + 1, 0))),
        ...
        Xl(i.scroller, "scroll", function() {
            i.scroller.clientHeight && (qn(e, i.scroller.scrollTop),
    ...
    function Go(e, t, n, r) {
        ...
        if (r || /\S/.test(s.text)) {
            ...
            u = 0,
            n = "not";
        "prev" == n ? u = t > o.first ? h(T(o, t - 1).text, null, l) : 0 : "add" == n ? u = a + e.options.indentUnit : "subtract" == n ? u = a - e.options.indentUnit : "number" == typeof n && (u = a + n),
        u = Math.max(0, u);
        var f = ""
          , d = 0;
        if (e.options.indentWithTabs)
            for (var g = Math.floor(u / l); g; --g)
                d += l,
                f += "\t";
        if (d < u && (f += p(u - d)),
        f != c)
            return Fi(o, f, E(t, 0), E(t, c.length), "+input"),
            s.stateAfter = null,
            !0;
            ...
            if (Ks && Ks.text.join("\n") == t) {
                if (r.ranges.length % Ks.text.length == 0) {
                    ...
                    for (var u = 0; u < Ks.text.length; u++)
                        a.push(o.splitLines(Ks.text[u]))
                }
            } else
                s.length == r.ranges.length && e.options.pasteLinesPerSelection && (a = v(s, function(e) {
                    return [e]
                }));
            ...
            for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
                ...
                if (!(i.head.ch > 100 || r && n.ranges[r - 1].head.line == i.head.line)) {
                    ...
                    if (o.electricChars) {
                        ...
                        o.electricInput && o.electricInput.test(T(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = Go(e, i.head.line, "smart"));
    ...
    function _o() {
        ...
        return hl ? e.style.width = "1000px" : e.setAttribute("wrap", "off"),
        yl && (e.style.border = "1px solid black"),
        Yo(e),
        t
    }
    function $o(e, t, n, r, i) {
        function o() {
            var r = t.line + n;
            return !(r < e.first || r >= e.first + e.size) && (t = new E(r,t.ch,t.sticky),
            u = T(e, r))
        }
        function l(r) {
            var l;
    ...
    function el(e, t, n, r, i) {
        ...
        for (var u = "", c = !1, h = e.doc.lineSeparator(); a(t),
        t != n; )
            t = t.nextSibling;
        return u
    }
    function tl(e, t, n) {
        ...
        if (t == e.display.lineDiv) {
            if (!(r = e.display.lineDiv.childNodes[n]))
                return Jo(e.clipPos(E(e.display.viewTo - 1)), !0);
            t = null,
            n = 0
        } else
    ...
    function nl(e, t, n) {
        ...
        n && (n = a.nodeValue.length)); u.parentNode != i; )
            u = u.parentNode;
        var c = e.measure
          , h = c.maps
          , f = r(a, u, n);
        ...
        for (var d = u.nextSibling, p = a ? a.nodeValue.length - n : 0; d; d = d.nextSibling) {
            if (f = r(d, d.firstChild, 0))
                return Jo(E(f.line, f.ch - p), l);
            p += d.textContent.length
        }
        for (var v = u.previousSibling, m = n; v; v = v.previousSibling) {
            if (f = r(v, v.firstChild, -1))
                return Jo(E(f.line, f.ch + m), l);
    ...
    Ll && Ll >= 15 && (pl = !1,
    hl = !0);
    var kl, Ml = xl && (fl || pl && (null == Ll || Ll < 12.11)), Tl = ol || ul && cl >= 9, Nl = function(t, n) {
        var r = t.className
          , i = e(n).exec(r);
        if (i) {
    ...
    kl = document.createRange ? function(e, t, n, r) {
    ...
    var Wl, Dl, Hl = 30, Fl = {
        ...
        return function(n, r) {
            ...
            if (0 == n.length || "ltr" == r && !i.test(n))
                return !1;
            for (var c = n.length, h = [], f = 0; f < c; ++f)
            ...
            for (var m = 0, y = u; m < c; ++m) {
                var b = h[m];
                "1" == b && "r" == y ? h[m] = "n" : l.test(b) && (y = b,
                "r" == b && (h[m] = "R"))
            }
            for (var w = 1, x = h[0]; w < c - 1; ++w) {
                var C = h[w];
                "+" == C && "1" == x && "1" == h[w + 1] ? h[w] = "1" : "," != C || x != h[w + 1] || "1" != x && "n" != x || (h[w] = x),
                x = C
            }
            for (var S = 0; S < c; ++S) {
                var L = h[S];
                if ("," == L)
                    ...
                    for (k = S + 1; k < c && "%" == h[k]; ++k)
                        ;
                    for (var M = S && "!" == h[S - 1] || k < c && "1" == h[k] ? "1" : "N", T = S; T < k; ++T)
                        h[T] = M;
                    S = k - 1
                }
            }
            ...
            for (var W = 0; W < c; ++W)
                if (o.test(h[W])) {
                    ...
                    for (D = W + 1; D < c && o.test(h[D]); ++D)
                        ;
                    for (var H = "L" == (W ? h[W - 1] : u), F = H == ("L" == (D < c ? h[D] : u)) ? H ? "L" : "R" : u, E = W; E < D; ++E)
                        h[E] = F;
                    W = D - 1
                }
            for (var P, I = [], R = 0; R < c; )
                    ...
                    for (var U = B; U < R; )
                        if (a.test(h[U])) {
                            ...
                            for (++U; U < R && a.test(h[U]); ++U)
                                ;
                            I.splice(G, 0, new t(2,V,U)),
                            B = U
                        } else
                            ++U;
                    B < R && I.splice(G, 0, new t(1,B,R))
                }
            return 1 == I[0].level && (P = n.match(/^\s+/)) && (I[0].from = P[0].length,
            I.unshift(new t(0,0,P[0].length))),
            1 == g(I).level && (P = n.match(/\s+$/)) && (g(I).to -= P[0].length,
            I.push(new t(0,c - P[0].length,c))),
            "rtl" == r ? I.reverse() : I
        }
    }(), jl = [], Xl = function(e, t, n) {
    ...
    }(), Zl = null, Ql = {}, Jl = {}, es = {}, ts = function(e, t, n) {
    ...
    ,
    Fe(os);
    var ls, ss = {}, as = {}, us = null, cs = null, hs = {
        left: 0,
        right: 0,
        top: 0,
        bottom: 0
    ...
    fs.prototype.zeroWidthHack = function() {
        ...
        this.disableHoriz = new Al,
        this.disableVert = new Al
    }
    ,
    ...
    var ms = 0
      , ys = null;
    ul ? ys = -.53 : ol ? ys = 15 : dl ? ys = -.7 : gl && (ys = -1 / 3);
    var bs = function(e, t) {
        this.ranges = e,
        this.primIndex = t
    };
    ...
    bs.prototype.equals = function(e) {
        ...
        for (var n = 0; n < this.ranges.length; n++) {
            var r = t.ranges[n]
              , i = e.ranges[n];
            if (!I(r.anchor, i.anchor) || !I(r.head, i.head))
                return !1
        }
        return !0
    }
    ...
    bs.prototype.deepCopy = function() {
        for (var e = this, t = [], n = 0; n < this.ranges.length; n++)
            t[n] = new ws(R(e.ranges[n].anchor),R(e.ranges[n].head));
    ...
    xs.prototype.changed = function() {
        ...
        n && hr(n, function() {
            ...
            Gi(n, r, i),
            St(n, "lineWidgetChanged", n, e, W(r))
        }))
    }
    ,
    Fe(xs);
    ...
    Ss.prototype.clear = function() {
        ...
        if (!this.explicitlyCleared) {
            ...
            for (var i = null, o = null, l = 0; l < this.lines.length; ++l) {
                var s = e.lines[l]
                  , a = _(s.markedSpans, e);
                t && !e.collapsed ? vr(t, W(s), "text") : t && (null != a.to && (o = W(s)),
                null != a.from && (i = W(s))),
                s.markedSpans = $(s.markedSpans, a),
                null == a.from && e.collapsed && !ve(e.doc, s) && t && A(s, yn(t.display))
            }
    ...
    Ss.prototype.find = function(e, t) {
        ...
        for (var r, i, o = 0; o < this.lines.length; ++o) {
            var l = n.lines[o]
              , s = _(l.markedSpans, n);
            if (null != s.from && (r = E(t ? l : W(l), s.from),
            -1 == e))
                return r;
            if (null != s.to && (i = E(t ? l : W(l), s.to),
            1 == e))
                return i
        }
        return r && {
    ...
    Ss.prototype.detachLine = function(e) {
        if (this.lines.splice(f(this.lines, e), 1),
    ...
    var ks = 0
      , Ms = function(e, t, n, r, i) {
        ...
        null == n && (n = 0),
        Bi.call(this, [new zi([new os("",null)])]),
        this.first = n,
    ...
    Ms.prototype = b(Bi.prototype, {
        ...
        setSelections: pr(function(e, t, n) {
            ...
            if (e.length) {
                for (var i = [], o = 0; o < e.length; o++)
                    i[o] = new ws(U(r, e[o].anchor),U(r, e[o].head));
        ...
        addSelection: pr(function(e, t, n) {
            ...
            r.push(new ws(U(this, e),U(this, t || e))),
            yi(this, Ir(r, r.length - 1), n)
        }),
        ...
        replaceSelections: pr(function(e, t, n) {
            ...
            for (var a = t && "end" != t && Vr(this, i, t), u = i.length - 1; u >= 0; u--)
                Ni(r, i[u]);
    ...
    for (var Ws = 65; Ws <= 90; Ws++)
        Os[Ws] = String.fromCharCode(Ws);
    for (var Ds = 1; Ds <= 12; Ds++)
        Os[Ds + 111] = Os[Ds + 63235] = "F" + Ds;
    var Hs = {};
    Hs.basic = {
        Left: "goCharLeft",
        Right: "goCharRight",
            ...
            return hr(e, function() {
                for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++)
                    if (t[r].empty()) {
                        ...
                        if (o)
                            if (i.ch == o.length && (i = new E(i.line,i.ch - 1)),
                            i.ch > 0)
                                i = new E(i.line,i.ch + 1),
                                e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), E(i.line, i.ch - 2), i, "+transpose");
                            else if (i.line > e.doc.first) {
                                var l = T(e.doc, i.line - 1).text;
                                l && (i = new E(i.line,1),
                                e.replaceRange(o.charAt(0) + e.doc.lineSeparator() + l.charAt(l.length - 1), E(i.line - 1, l.length - 1), i, "+transpose"))
                            }
                        n.push(new ws(i,i))
                    }
                e.setSelections(n)
    ...
    js.prototype.init = function(e) {
        function t(e) {
            if (!We(i, e)) {
                ...
                s.value = Ks.text.join("\n");
                var a = document.activeElement;
                Ol(s),
                setTimeout(function() {
                    i.display.lineSpace.removeChild(l),
                    a.focus(),
                    a == o && r.showPrimarySelection()
                }, 50)
            }
        }
        var n = this
        ...
        Xl(o, "paste", function(e) {
            We(i, e) || Ko(e, i) || cl <= 11 && setTimeout(fr(i, function() {
        ...
        if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || i.line < t.display.viewFrom)
            ...
            if (!o || o.bad || !l || l.bad || 0 != P(B(o, l), r) || 0 != P(z(o, l), i)) {
                var s = t.display.view
                  , a = r.line >= t.display.viewFrom && Zo(t, r) || {
                ...
                if (a && u) {
                    ...
                    f && (!ol && t.state.focused ? (e.collapse(a.node, a.offset),
    ...
    js.prototype.pollSelection = function() {
        if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
            var e = window.getSelection()
              , t = this.cm;
            if (bl && dl && this.cm.options.gutters.length && Qo(e.anchorNode))
    ...
    js.prototype.pollContent = function() {
        ...
        var e = this.cm
          ...
          , r = n.from()
          , i = n.to();
        if (0 == r.ch && r.line > e.firstLine() && (r = E(r.line - 1, T(e.doc, r.line - 1).length)),
        i.ch == T(e.doc, i.line).text.length && i.line < e.lastLine() && (i = E(i.line + 1, 0)),
        r.line < t.viewFrom || i.line > t.viewTo - 1)
            return !1;
        var o, l, s;
        r.line == t.viewFrom || 0 == (o = kn(e, r.line)) ? (l = W(t.view[0].line),
        s = t.view[0].node) : (l = W(t.view[o].line),
        s = t.view[o - 1].node.nextSibling);
        var a, u, c = kn(e, i.line);
        if (c == t.view.length - 1 ? (a = t.viewTo - 1,
        u = t.lineDiv.lastChild) : (a = W(t.view[c + 1].line) - 1,
        ...
        for (var d = 0, p = 0, v = h[0], m = f[0], y = Math.min(v.length, m.length); d < y && v.charCodeAt(d) == m.charCodeAt(d); )
            ++d;
        for (var b = g(h), w = g(f), x = Math.min(b.length - (1 == h.length ? d : 0), w.length - (1 == f.length ? d : 0)); p < x && b.charCodeAt(b.length - p - 1) == w.charCodeAt(w.length - p - 1); )
            ++p;
        if (1 == h.length && 1 == f.length && l == r.line)
            for (; d && d > r.ch && b.charCodeAt(b.length - p - 1) == w.charCodeAt(w.length - p - 1); )
                d--,
                p++;
        ...
        return h.length > 1 || h[0] || P(C, S) ? (Fi(e.doc, h, C, S, "+input"),
        !0) : void 0
    }
    ,
    ...
    js.prototype.onKeyPress = function(e) {
        ...
        this.cm.isReadOnly() || fr(this.cm, Vo)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
    }
    ,
    ...
    Xs.prototype.init = function(e) {
        function t(e) {
            if (!We(i, e)) {
                if (i.somethingSelected())
                    ...
                    "cut" == e.type ? i.setSelections(t.ranges, null, El) : (r.prevInput = "",
                    l.value = t.text.join("\n"),
                    Ol(l))
                }
        ...
        Xl(l, "input", function() {
            ul && cl >= 9 && n.hasSelection && (n.hasSelection = null),
            r.poll()
        }),
        Xl(l, "paste", function(e) {
            We(i, e) || Ko(e, i) || (i.state.pasteIncoming = !0,
            r.fastPoll())
        }),
        Xl(l, "cut", t),
        Xl(l, "copy", t),
        Xl(e.scroller, "paste", function(t) {
            Rt(e, t) || We(i, t) || (i.state.pasteIncoming = !0,
            r.focus())
        }),
    ...
    Xs.prototype.reset = function(e) {
        if (!this.contextMenuPending && !this.composing) {
            ...
            if (t.somethingSelected()) {
                ...
                t.state.focused && Ol(this.textarea),
                ul && cl >= 9 && (this.hasSelection = n)
            } else
                e || (this.prevInput = this.textarea.value = "",
                ul && cl >= 9 && (this.hasSelection = null))
        }
    }
    ,
    ...
    Xs.prototype.poll = function() {
        var e = this
          ...
          , n = this.textarea
          , r = this.prevInput;
        if (this.contextMenuPending || !t.state.focused || $l(n) && !r && !this.composing || t.isReadOnly() || t.options.disableInput || t.state.keySeq)
            return !1;
        var i = n.value;
        if (i == r && !t.somethingSelected())
            return !1;
        if (ul && cl >= 9 && this.hasSelection === i || xl && /[\uf700-\uf7ff]/.test(i))
    ...
    Xs.prototype.onContextMenu = function(e) {
        ...
        function n() {
            ...
            l.style.cssText = u,
            ul && cl < 9 && o.scrollbars.setScrollTop(o.scroller.scrollTop = a),
            null != l.selectionStart) {
                (!ul || ul && cl < 9) && t();
                var e = 0
                  , n = function() {
                    o.selForContextMenu == i.doc.sel && 0 == l.selectionStart && l.selectionEnd > 0 && "​" == r.prevInput ? fr(i, Mi)(i) : e++ < 10 ? o.detectingSelectAll = setTimeout(n, 500) : (o.selForContextMenu = null,
                    o.input.reset())
                };
    ...
    function(e) {
        ...
        t("lineSeparator", null, function(e, t) {
            ...
            t) {
                ...
                for (var i = n.length - 1; i >= 0; i--)
                    Fi(e.doc, t, n[i], E(n[i].line, n[i].ch + t.length))
            }
        }),
        ...
        t("electricChars", !0),
        t("inputStyle", wl ? "contenteditable" : "textarea", function() {
        ...
        e.prototype = {
            ...
            getHelpers: function(e, t) {
                ...
                if ("string" == typeof l[t])
                    ...
                    l.helperType && o[l.helperType] ? i.push(o[l.helperType]) : o[l.name] && i.push(o[l.name]);
            ...
            getStateAfter: function(e, t) {
                var n = this.doc;
                return e = G(n, null == e ? n.first + n.size - 1 : e),
                Je(this, e + 1, t).state
            },
            cursorCoords: function(e, t) {
                var n, r = this.doc.sel.primary();
                return n = null == e ? r.head : "object" == typeof e ? U(this.doc, e) : e ? r.from() : r.to(),
                hn(this, n, t || "page")
            },
            ...
            addWidget: function(e, t, n, r, i) {
                ...
                "over" == r)
                    ...
                    ("above" == r || e.bottom + t.offsetHeight > a) && e.top > t.offsetHeight ? l = e.top - t.offsetHeight : e.bottom + t.offsetHeight <= a && (l = e.bottom),
            ...
            findPosV: function(e, t, n, r) {
                ...
                for (var s = U(this.doc, e), a = 0; a < t; ++a) {
                    var u = hn(i, s, "div");
                    if (null == l ? l = u.left : u.left = l,
                    (s = qo(i, u, o, n)).hitSide)
                        break
                }
                return s
            },
            moveV: dr(function(e, t) {
                ...
                if (r.extendSelectionsBy(function(l) {
                    ...
                    i.push(s.left);
                    var a = qo(n, s, e, t);
                    return "page" == t && l == r.sel.primary() && Kn(n, cn(n, a, "div").top - s.top),
                    a
                }, Il),
                i.length)
            ...
            findWordAt: function(e) {
                ...
                if (t) {
                    ...
                    for (var o = t.charAt(n), l = x(o, i) ? function(e) {
                        return x(e, i)
                    }
                    : /\s/.test(o) ? function(e) {
                        return /\s/.test(e)
            ...
            toggleOverwrite: function(e) {
                null != e && e == this.state.overwrite || ((this.state.overwrite = !this.state.overwrite) ? s(this.display.cursorDiv, "CodeMirror-overwrite") : Nl(this.display.cursorDiv, "CodeMirror-overwrite"),
            ...
            refresh: dr(function() {
                ...
                Ar(this),
                (null == e || Math.abs(e - yn(this.display)) > .5) && Sn(this),
                Ae(this, "refresh", this)
            }),
    ...
    for (var _s in Ms.prototype)
        Ms.prototype.hasOwnProperty(_s) && f(Ys, _s) < 0 && (zo.prototype[_s] = function(e) {
            return function() {
